...
const LANG_GREETINGS: Record<string, string> = {
  ...
  bodo: 'खुलुमबाय! आं नोंथांनि SMRITI राव हेफाजाबगिरि। दिनै आं नोंथांखौ बोरै हेफाजाब होनो हागोन?',
  kn: 'ನಮಸ್ಕಾರ! ನಾನು ನಿಮ್ಮ ಸ್ಮೃತಿ ಧ್ವನಿ ಸಹಾಯಕ. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ?',
  ml: 'നമസ്കാരം! ഞാൻ നിങ്ങളുടെ സ്മൃതി വോയ്സ് അസിസ്റ്റന്റാണ്. இன்று நான் നിങ്ങളെ എങ്ങനെ സഹായിക്കട്ടെ?',
...
const LANG_STATE_LABELS: Record<string, Record<VoiceState, string>> = {
  ...
  bn: {
    ...
    LISTENING: 'শুনছি...',
    PROCESSING: 'বুঝছি...',
    CONFIRMING: 'নিশ্চিত করুন',
    SPEAKING: 'স্মৃতি+ কথা বলছে...',
    ERROR: 'আবার চেষ্টা করুন',
    OFFLINE: 'নেটওয়ার্ক নেই',
  },
  ta: {
    IDLE: 'பேச தட்டவும்',
    LISTENING: 'கேட்கிறேன்...',
    PROCESSING: 'புரிகிறது...',
    CONFIRMING: 'உறுதிப்படுத்தவும்',
    SPEAKING: 'SMRITI+ பேசுகிறது...',
  ...
  bodo: {
    ...
    PROCESSING: 'बुजि गासिनो...',
    CONFIRMING: 'थार खालाम',
    SPEAKING: 'SMRITI+ बुंगासिनो...',
    ERROR: 'फिन नाजा',
    OFFLINE: 'नेटवर्क गैया',
  },
  en: {
    IDLE: 'Tap to Speak',
    LISTENING: 'Listening...',
...
const QUICK_PHRASE_CHIPS: Record<string, Array<{ tag: string; phrase: string; spoken: string }>> = {
  ...
  bn: [
    { tag: '📋 সূচি', phrase: 'আজকের সূচি কী?', spoken: 'আমার আজকের কাজের সূচি কী?' },
    { tag: '💊 পরবর্তী ওষুধ', phrase: 'পরের ওষুধ কখন?', spoken: 'আমার পরের ওষুধ কখন খেতে হবে?' },
    { tag: '🌬️ শ্বাসপ্রশ্বাস', phrase: 'শান্তির শ্বাসপ্রশ্বাসের ব্যায়াম', spoken: 'আমাকে শান্তির শ্বাসপ্রশ্বাসের ব্যায়াম শেখাও' },
    { tag: '🧩 ধাঁধা', phrase: 'একটি মজার ধাঁধা বলো', spoken: 'একটি মজার ধাঁধা বলো' },
    { tag: '💧 জল', phrase: 'আজ জল খেয়েছি?', spoken: 'আমি কি আজ পর্যাপ্ত জল খেয়েছি?' },
    { tag: '🖼️ স্মৃতিমালা', phrase: 'পারিবারিক স্মৃতি দেখাও', spoken: 'আমার পারিবারিক স্মৃতি দেখাও' },
    { tag: '🎮 খেলা', phrase: 'একটি খেলা বলো', spoken: 'আমার জন্য একটি খেলা বেছে দাও' },
    { tag: '🛡️ নিরাপত্তা', phrase: 'দুটো ওষুধ একসাথে খাব?', spoken: 'আমি কি দুটো ওষুধ একসাথে খেতে পারি?' },
    { tag: '📞 পরিবার', phrase: 'পরিবারকে ফোন করো', spoken: 'আমার পরিবারকে ফোন করো' },
    { tag: '🔄 আবার', phrase: 'আবার বলো', spoken: 'আবার বলো' },
    { tag: '🛑 থামো', phrase: 'থামো', spoken: 'থামো' },
  ],
  ta: [
    { tag: '📋 அட்டவணை', phrase: 'இன்றைய அட்டவணை என்ன?', spoken: 'எனது இன்றைய அட்டவணை என்ன?' },
    { tag: '💊 அடுத்த மருந்து', phrase: 'அடுத்த மருந்து எப்போது?', spoken: 'எனது அடுத்த மருந்து எப்போது எடுக்க வேண்டும்?' },
    { tag: '🌬️ மூச்சுப்பயிற்சி', phrase: 'அமைதியான மூச்சுப்பயிற்சி', spoken: 'அமைதியான மூச்சுப்பயிற்சி சொல்லுங்கள்' },
    { tag: '🧩 விடுகதை', phrase: 'ஒரு விடுகதை சொல்லுங்கள்', spoken: 'ஒரு வேடிக்கையான விடுகதை சொல்லுங்கள்' },
    { tag: '💧 தண்ணீர்', phrase: 'இன்று தண்ணீர் குடித்தேனா?', spoken: 'இன்று நான் தண்ணீர் குடித்தேனா?' },
    { tag: '🖼️ நினைவுகள்', phrase: 'குடும்ப நினைவுகளைக் காட்டு', spoken: 'குடும்ப நினைவுகளைக் காட்டு' },
    { tag: '🎮 விளையாட்டு', phrase: 'மூளை விளையாட்டு காட்டு', spoken: 'ஒரு மூளை விளையாட்டு சொல்லுங்கள்' },
    { tag: '🛡️ பாதுகாப்பு', phrase: 'இரண்டு மாத்திரை போடலாமா?', spoken: 'இரண்டு மாத்திரைகளை ஒன்றாக போடலாமா?' },
    { tag: '📞 குடும்பம்', phrase: 'குடும்பத்திற்கு அழைக்கவும்', spoken: 'குடும்பத்திற்கு அழைக்கவும்' },
    { tag: '🔄 மீண்டும்', phrase: 'மீண்டும் சொல்', spoken: 'மீண்டும் சொல்' },
    { tag: '🛑 நிறுத்து', phrase: 'நிறுத்து', spoken: 'நிறுத்து' },
  ],
  bodo: [
    { tag: '📋 फारिलाइ', phrase: 'दिनैनि फारिलाइ मा?', spoken: 'आंनि दिनैनि फारिलाइ मा?' },
    { tag: '💊 उनाव मुलि', phrase: 'उनाव मुलि जाग्रा समा मा?', spoken: 'आंनि उनाव मुलि जाग्रा समा मा?' },
    { tag: '🌬️ हासह\'नाय', phrase: 'गोजोन हासह\'नाय बिथांखि', spoken: 'आंनो गोजोन हासह\'नाय बिथांखि खोनथा' },
    { tag: '🧩 बाथ्रा सोंथि', phrase: 'मोनसे बाथ्रा सोंथि सों', spoken: 'मोनसे मोजां बाथ्रा सोंथि सों' },
    { tag: '💧 दै', phrase: 'दिनै दै लोंबाय नामा?', spoken: 'आं दिनै दै लोंबाय नामा?' },
    { tag: '🖼️ गोसोखांथि', phrase: 'नख\'रनि गोसोखांथि दिन्थि', spoken: 'नख\'रनि गोसोखांथि दिन्थि' },
    { tag: '🎮 गेम', phrase: 'मोनसे गेम खोनथा', spoken: 'आंनि थाखाय मोनसे गेम खोनथा' },
    { tag: '🛡️ रैखाथि', phrase: 'मुलि मोननै जानांगौ नामा?', spoken: 'मुलि मोननै लोगोसे जानो हागोन नामा?' },
    { tag: '📞 नख\'र', phrase: 'नख\'रनो फन खालाम', spoken: 'नख\'रनो फन खालाम' },
    { tag: '🔄 फिन', phrase: 'फिन बुं', spoken: 'फिन बुं' },
    { tag: '🛑 थाथ\'', phrase: 'थाथ\'', spoken: 'थाथ\'' },
  ],
  en: [
    ...
    >
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <Text style={styles.backBtnText}>{t('voice.back') || t('nav.back') || 'Back'}</Text>
        </TouchableOpacity>

        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle} numberOfLines={1}>{t('voice.headerTitle') || 'SMRITI+ Voice'}</Text>
