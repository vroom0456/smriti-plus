...
export const LANGUAGE_PROFILES: Record<string, LanguageProfile> = {
  ...
  as: {
    ...
    speechRate: 0.82,
    pitch: 1.0,
    defaultHonorific: 'দেউতা',
    emotionalTemplates: {
      greeting: 'নমস্কাৰ দেউতা! আজি আপোনাক কেনেকৈ সহায় কৰিব পাৰোঁ?',
  ...
  bn: {
    ...
    speechRate: 0.82,
    pitch: 1.0,
    defaultHonorific: 'কাকাবাবু',
    emotionalTemplates: {
      greeting: 'নমস্কার কাকাবাবু! আজ আপনাকে কীভাবে সাহায্য করতে পারি?',
  ...
  ta: {
    ...
    speechRate: 0.82,
    pitch: 1.0,
    defaultHonorific: 'ஐயா',
    emotionalTemplates: {
      greeting: 'வணக்கம்! இன்று நான் உங்களுக்கு எவ்வாறு உதவ முடியும்?',
      praise: 'மிக நன்று! நீங்கள் மிகவும் அமைதியாகவும் கவனமாகவும் செய்து முடித்தீர்கள்.',
      comfort: 'பரவாயில்லை, நாம் மெதுவாக மீண்டும் முயற்சி செய்வோம்.',
      confusion: 'நீங்கள் உங்கள் வீட்டில் பாதுகாப்பாக உள்ளீர்கள். ஒவ்வொன்றாக அமைதியாகச் செய்வோம்.',
      repeat: 'நிச்சயமாக, நான் மீண்டும் கூறுகிறேன்.',
      farewell: 'நல்லபடியாக இருங்கள், அமைதியான நாளாக அமையட்டும்.',
      offlineNotice: 'இணைய இணைப்பு இல்லை, ஆனால் உங்கள் அட்டவணை பாதுகாப்பாக உள்ளது.',
      safetyRefusal: 'நான் உங்கள் அன்றாட நினைவூட்டல்களில் உதவ முடியும், மருத்துவ உதவிக்கு மருத்துவரை அணுகவும்.',
    },
    prohibitedMixing: [],
  },
